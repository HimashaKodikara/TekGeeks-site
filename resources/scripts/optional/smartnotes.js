...
window.onload = function () {
    ...
    const createNewNoteBtn = document.getElementById('create-new-note');
    if (createNewNoteBtn) {
        createNewNoteBtn.addEventListener('click', createNewNote)
    }

    const showNotesListBtn = document.getElementById('show-notes-list');
    if (showNotesListBtn) {
        showNotesListBtn.addEventListener('click', showNotesList)
    }

    const formatTextBoldBtn = document.getElementById('format-text-bold');
    if (formatTextBoldBtn) {
        formatTextBoldBtn.addEventListener('click', () => formatText('bold'))
    }

    const formatTextItalicBtn = document.getElementById('format-text-italic');
    if (formatTextItalicBtn) {
        formatTextItalicBtn.addEventListener('click', () => formatText('italic'))
    }

    const formatTextUnderlineBtn = document.getElementById('format-text-underline');
    if (formatTextUnderlineBtn) {
        formatTextUnderlineBtn.addEventListener('click', () => formatText('underline'))
    }
};
