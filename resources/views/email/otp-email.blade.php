                ...
                <table role="presentation" style="width: 600px; margin: 0 auto; border-collapse: collapse; background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                    ...
                    <tr>
                        <td style="padding: 40px 40px 20px 40px; text-align: center;">
                            <h1 style="margin: 0; color: #2c3e50; font-size: 20px; font-weight: bold;">Verify Your Email Address</h1>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 0 40px 10px 40px; text-align: center;">
                            <p style="margin: 0 0 20px 0; color: #555555; font-size: 14px; line-height: 1.4;">
                                Thank you for registering with the Declaration of Assets and Liabilities System. To complete your registration and verify your email address, please use the following One-Time Password (OTP):
                            </p>
                        </td>
                    </tr>
                                ...
                                <tr>
                                    <td style="padding: 20px;">
                                        ...
                                        <p style="margin: 0; color: #856404; font-size: 13px; line-height: 1.5;">
                                            If you did not attempt to create an account using this email address, please ignore this email. No action is required, and your email address will not be verified.
                                        </p>
                                    </td>
                                </tr>
                            </table>
