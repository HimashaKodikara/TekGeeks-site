@extends('layouts.vertical', ['pageTitle' => 'Roles List'])
...
@section('content')
    ...
    <div class="panel panel-default" id="panel-users">
        <div class="panel-hdr">
            <h2>Roles <span class="fw-light"><i>List</i></span></h2>
        </div>
        <div class="panel-container">
            <div class="panel-content table-responsive">
                <table id="roles-table" class="table table-striped table-hover table-bordered table-sm align-middle nowrap" style="width:100%">
                        <thead>
                            <tr>
