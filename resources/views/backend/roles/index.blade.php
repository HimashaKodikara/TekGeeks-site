        ...
        <div class="panel panel-icon" id="panel-1">
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    <form id="user-form" action="{{ route('roles.store') }}" method="POST" enctype="multipart/form-data" data-parsley-validate novalidate>
                        @csrf
                                        ...
                                        <div class="panel-container">
                                            <div class="panel-content">
                                                ...
                                                <div class="form-check mb-2">
                                                    <input type="checkbox" class="form-check-input" id="defaultUnchecked{{ $value->id }}" name="permission[]" value="{{ $value->name }}">
                        ...
                        <div class="panel-content border-faded border-start-0 border-end-0 border-bottom-0 d-flex flex-row">
                            <button class="btn btn-primary ms-auto" type="submit">Create</button>
                        </div>
                    </form>
                </div>
            </div>
