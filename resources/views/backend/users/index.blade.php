        ...
        <div class="panel panel-icon" id="panel-1">
            <div class="panel-hdr">
                ...
                {{-- <div class="panel-toolbar">
                    <button class="btn btn-panel" data-action="panel-collapse" data-bs-offset="0,10" data-bs-original-title="Toggle" data-bs-placement="top" data-bs-toggle="tooltip" type="button">
                        <svg class="sa-icon">
                    ...
                    <button class="btn btn-panel" data-action="panel-fullscreen" data-bs-offset="0,10" data-bs-original-title="Fullscreen" data-bs-placement="top" data-bs-toggle="tooltip" type="button">
                        <svg class="sa-icon">
                            <use href="/icons/sprite.svg#stop-circle"></use>
                        </svg>
                    </button>
                    <button class="btn btn-panel" data-action="panel-close" data-bs-offset="0,10" data-bs-original-title="Close" data-bs-placement="top" data-bs-toggle="tooltip" type="button">
                        <svg class="sa-icon">
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    <form id="user-form" action="{{ route('users.store') }}" method="POST" data-parsley-validate novalidate>
                        @csrf
                        <input type="hidden" name="_from" value="{{ url()->current() }}">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Name <span class="text-danger">*</span></label>
                                <input class="form-control" type="text" name="name" value="" data-parsley-maxlength="150" data-parsley-minlength="3" data-parsley-trigger="change" data-parsley-required-message="Name is required" data-parsley-minlength-message="Name must be at least 3 characters" data-parsley-required="true"/>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Email <span class="text-danger">*</span></label>
                                <input class="form-control" id="email" name="email" placeholder="Email" type="email" value="" data-parsley-maxlength="150" data-parsley-type="email" data-parsley-required-message="Email is required" data-parsley-type-message="Enter a valid email" data-parsley-required="true" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label">NIC <span class="text-danger">*</span></label>
                                <input class="form-control" id="nic" name="nic" placeholder="NIC" type="text" value="" data-parsley-maxlength="12" data-parsley-required="true" data-parsley-required-message="NIC is required" />
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Contact Number <span class="text-danger">*</span></label>
                                <input class="form-control" name="contact_number" placeholder="Contact Number" type="text" value="" data-parsley-maxlength="12" data-parsley-required="true" data-parsley-required-message="Contact number is required" />
                            </div>
                            <div class="col-md-6 mb-3">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="password-wrapper position-relative">
                                    <input class="form-control" id="password" type="password" name="password" value="" data-parsley-strong-password data-parsley-required-message="Password is required" data-parsley-minlength-message="Password must be at least 6 characters" data-parsley-maxlength="191" data-parsley-required="true" />
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="password-wrapper position-relative">
                                    <input class="form-control" type="password" name="password_confirmation" value="" data-parsley-equalto="#password" data-parsley-errors-container="#confirm-password-error" data-parsley-maxlength="191" data-parsley-required="true" data-parsley-required-message="Confirm password is required" />
                        ...
                        <div class="panel-content border-faded border-start-0 border-end-0 border-bottom-0 d-flex flex-row">
                            <button id="user-submit" class="btn btn-primary ms-auto" type="submit">Create</button>
                        </div>
                    </form>
                </div>
            </div>
