    ...
    <main id="js-page-content" role="main" class="page-content">
        ...
        <div class="subheader">
            <h1 class="subheader-title">
                <i class='subheader-icon fal fa-chart-area'></i> Create Home Project <span class='fw-300'></span>
            </h1>
        ...
        <div class="row">
            <div class="col-xl-12">
                <div id="panel-1" class="panel">
                    <div class="panel-hdr">
                        <h2>
                            Create <span class="fw-300"><i>Home Project</i></span>
                        </h2>
                    </div>
                    <div class="panel-container show">
                        <div class="panel-content">
                            <form action="{{ route('home-project.store') }}" enctype="multipart/form-data" method="post"
                                ...
                                <div class="col-12">
                                    <div class="flex-row panel-content border-faded d-flex">
                                        <button id="js-submit-btn" class="ml-auto btn btn-primary" type="submit">Submit</button>
                                    </div>
                                </div>
                            </form>
                        </div>
